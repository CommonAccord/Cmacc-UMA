Doc.Title=Facebook Platform Policy
...
Encourage.=[Wx/com/facebook/developers/policy/Sec/UserControl_v01.md]

ProtectData.=[Wx/com/facebook/developers/policy/Sec/ProtectData_v01.md]
...
6.14.sec=We can issue a press release describing our relationship with you.
...
9.1.1.sec=Don’t share the same app ID with a desktop web game off of Facebook.com.

9.1.2.sec=Don’t use your Facebook.com game or email addresses you’ve obtained from us to promote or link to a desktop web game off of Facebook. 

9.1.3.sec=Use Facebook Payments as your only payment method for all in-game purchases.

9.1.4.sec=Use Facebook Payments offers if you reward people for actions involving third parties. 

9.1.=[Z/ol-a/s4]

9.2.0.sec=Desktop web games off Facebook.com:

9.2.1.sec=Only use Facebook Login, social plugins, and publishing channels. Don’t use connections such as friends lists. 

9.2.2.sec=During authentication, only request age, email, and publishing permissions.

9.2.=[Z/ol-a/s2]

9.3.0.sec=Games on mobile:

9.3.1.sec=Don’t share the same app ID with a desktop web game off of Facebook.com.

9.3.2.sec=Don’t use your mobile game or email addresses you’ve obtained from us to promote or link to a web game off of Facebook.
...
11.2.1.sec=Ensure the app’s name and information are grammatically correct. 

11.2.2.sec=Ensure the app’s language matches the App Center locale. 

11.2.3.sec=Don't include URLs or use the Facebook brand. 

11.2.4.sec=Don’t include keyword lists, excessive punctuation, or non-standard symbols. 

11.2.=[Z/ol-a/s4]

11.3.0.sec=All Images:

11.3.1.sec=Use high quality, relevant images that reflect the app experience. 

11.3.2.sec=Keep any image text concise. Don't obstruct images with text. 

11.3.3.sec=Don’t include ads, URLs or gimmicks such as Play buttons. 

11.3.=[Z/ol-a/s3]

11.4.0.sec=Icons:

11.4.1.sec=Use a transparent or colored background. If your icon requires a white background, use a colored border. 

11.4.2.sec=If your logo has a drop shadow, use a colored background. 

11.4.=[Z/ol-a/s2]

11.5.0.sec=Banners:

11.5.1.sec=Don’t include rounded edges or borders. 

11.5.2.sec=Don’t include third party logos.

11.5.=[Z/ol-a/s2]

11.6.0.sec=Videos:

11.6.1.sec=Display the app's name. 

11.6.2.sec=Clearly represent the purpose of the app and show accurate, relevant in-app experiences.

11.6.3.sec=Keep your video high-quality and high-resolution. 

11.6.4.sec=Your video and its video cover image should be clear and recognizable. Don't include ads.
...
12.1.1.sec=Don’t recreate actions that are already supported.

12.1.2.sec=Write the action and object in a clear and simple way. 

12.1.3.sec=Make sure the story is grammatically correct. 

12.1.4.sec=Use English for your submission. 

12.1.5.sec=Don’t indicate a person’s consumption, browsing, discovering, or viewing of content.

12.1.6.sec=Don’t indicate a person has installed, visited, or connected to your app. 

12.1.=[Z/ol-a/s6]

12.2.0.sec=Read and Watch Actions:

12.2.1.sec=Publish actions only after a person has been on a page for more than 10 seconds.

12.2.2.sec=Allow people to remove stories published to Facebook on the same page where the content is hosted. 
...
14.6.1.sec=Don’t allow more than 50 ad creations a day per customer.

14.6.2.sec=Require phone or email verification on new accounts.

14.6.3.sec=Don’t allow affiliate networks to use your technology.

14.6.=[Z/ol-a/s3]

14.7.0.sec=Pricing transparency:

14.7.1.sec=Only charge fees for the use of your tools and managed services with a fixed fee or variable percentage of ad spend.

14.7.2.sec=Proactively disclose to end advertisers the amount that you spent on Facebook advertising, using Facebook metrics (e.g., CPC, CPM rate), separate from your fees.

14.7.3.sec=Disclose the amount you charged as fees on Facebook advertising.

14.7.4.sec=We may disclose fees or the amount you spent on Facebook advertising to your clients if they request it.

14.7.5.sec=We may require documentation from you to ensure your compliance with these terms.

14.7.6.sec=Don’t sell ads on a fixed CPM or CPC basis when using the Facebook advertising auction.

14.7.=[Z/ol-a/s6]

14.8.0.sec=Data Collection and Use:

14.8.1.sec=If you have Standard Ads API access and our prior written permission, you can place 1x1 pixel view tags on advertisements.

14.8.2.sec=Ensure that any data that is collected is anonymous.

14.8.3.sec=Only use data from an end-advertiser’s campaign to optimize or measure the performance of that end-advertiser’s Facebook campaign.

14.8.4.sec=Don’t use data to retarget on or off of Facebook.

14.8.5.sec=Don’t mix data obtained from us with advertising campaigns on different platforms.

14.8.6.sec=Don’t use data to build or augment any user profiles.

14.8.7.sec=Don’t use piggybacking or redirects.

14.8.8.sec=Don’t let people other than those acting on an end-advertiser’s behalf access Facebook ad statistics.
...
14.10.1.sec=If you use custom audiences, comply with the Custom Audience Terms.

14.10.2.sec=Only use a client’s data when creating custom audiences on their behalf.

14.10.3.sec=Only use a Facebook User ID to create custom audiences when the person whose User ID is being used has logged into the client’s app and has given the necessary consent.

14.10.4.sec=Don’t sell or transfer custom audiences.
...
15.5.sec=Don't prevent people from gaining access to any Page you create or manage on their behalf.
